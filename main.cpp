...
int main() {
    try {
        ...
        CrashHandler::instance().gracefulExit(EXIT_FAILURE, "Main exception: " + std::string(e.what()));
    } catch (...) {
        CrashHandler::instance().gracefulExit(EXIT_FAILURE, "Main unknown exception");
    }
